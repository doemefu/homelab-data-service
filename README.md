...
| NM-3 (#15) | Flyway `V3__netmon_lan`; `lan` collector (Prometheus snapshots of the node-script metrics every 15 min); `GET /api/netmon/lan/connections`, `/lan/ufw-blocks`, `/lan/ssh-auth`; `lan` block in `/ips/{ip}` | in review |
