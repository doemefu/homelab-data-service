...
| NM-2 (#16) | Flyway `V4__netmon_egress`; `egress` collector (hourly Prometheus snapshots of the coroot-node-agent TCP counters); `GET /api/netmon/egress/top` | in review |
